...
<p align="center">
  <img src="../docs/logo/gatewa_logo.svg" alt="GateWA Logo" width="120"/>
</p>

Modern web dashboard for managing GateWA WhatsApp API Gateway sessions, webhooks, and infrastructure.
...
The dashboard connects to the GateWA API backend. Configure the API URL in environment variables:
...
MIT License - Part of the [GateWA](https://github.com/sam3690/GateWA) project.
