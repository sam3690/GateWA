    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-logo">
          <img src="/gatewa_logo.svg" alt="GateWA" className="logo-icon" />
        ...
        <p className="login-help">
          {t('login.help')}{' '}
          <a
            href="https://github.com/sam3690/GateWA/blob/main/docs/01-project-overview.md"
            target="_blank"
      ...
      <footer className="login-footer">
        ...
        <a
          href="https://github.com/sam3690/GateWA"
          target="_blank"
          rel="noopener noreferrer"
