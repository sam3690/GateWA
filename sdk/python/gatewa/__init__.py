...
@dataclass
class GateWAClientConfig:
    """Configuration for the GateWA client."""
...
class GateWAClient:
    ...
    def __init__(self, base_url: str, api_key: str, timeout: float = 30.0) -> None:
        self.config = GateWAClientConfig(
    ...
    def _request(self, method: str, path: str, json: Any = None) -> Any:
        ...
        try:
            ...
            raise ImportError(
                "httpx is required for the GateWA SDK. "
                "Install it with: pip install gatewa-sdk"
            )
...
class _SessionsResource:
    def __init__(self, client: GateWAClient) -> None:
        self._client = client
