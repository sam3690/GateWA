<p align="center">
  <img src="logo/gatewa_logo.svg" alt="GateWA Logo" width="200"/>
</p>

<h1 align="center">GateWA Documentation</h1>
<p align="center">
...
| 22  | [n8n Integration](./22-n8n-integration.md)                       | n8n community nodes for GateWA                    |
...
GateWA seeds a default API key on first run and writes it to:
...
curl -X POST http://localhost:2785/api/sessions/{sessionId}/messages/send-text \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{"chatId": "628123456789@c.us", "text": "Hello from GateWA!"}'
```
...
_GateWA Documentation · Last updated: 2026-02-05_
