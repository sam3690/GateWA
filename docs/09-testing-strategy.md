...
>
> This document outlines the planned testing strategy for GateWA. The current implementation includes only foundational tests:
>
  ...
  integration-tests:
    ...
    steps:
      ...
      - run: npm run test:integration
        env:
          DATABASE_URL: postgresql://test:test@localhost:5432/gatewa_test
