...
├── Docker image (ghcr.io/sam3690/gatewa:0.0.1)
├── docker-compose.yml
...
├── Docker image (ghcr.io/sam3690/gatewa:0.0.2)
...
├── Docker image (ghcr.io/sam3690/gatewa:0.1.0)
