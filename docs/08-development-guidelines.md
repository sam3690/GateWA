...
GateWA supports multiple infrastructure configurations. Choose based on your needs:
...
DATABASE_URL=postgresql://gatewa:gatewa@localhost:5432/gatewa
...
docker run --shm-size=2gb gatewa
```
