...
The dashboard is a web-based management interface for GateWA that lets users manage sessions, webhooks, and monitor activity without using the API directly.
...
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │  🔗 Main Webhook                                   ✅ Active   │  │
│  │  https://api.example.com/webhook/gatewa                        │  │
